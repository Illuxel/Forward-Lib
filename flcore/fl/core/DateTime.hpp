...
namespace Forward {
    ...
    private:
        std::optional<ChronoTime> time_point_ = std::nullopt;
    ...
    public:
        ...
        DateTime(ChronoTime const& time_point);
        ...
        /**
         * Creates time point from string
         * 
         ...
         * @return 
         */
        static ChronoTime FromTmToChrono(std::tm time_info);
        /**
         ...
         * @return 
         */
        static std::tm FromChronoToTm(ChronoTime time_point);
        ...
        bool operator==(ChronoTime const& right) const;

        DateTime& operator=(DateTime&& right) noexcept;
        DateTime& operator=(DateTime const& right) noexcept;

        operator ChronoTime() const
        {
            return time_point_.value_or(ChronoTime());
        }
